...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.storage=void 0;const e={saveUserData(e,t){try{const s=JSON.stringify(t);localStorage.setItem(e,s)}catch(r){console.error("Set state error: ",r.message)}},getUserData(e){try{return JSON.parse(localStorage.getItem(e))}catch(t){console.error("Get state error: ",t.message)}}};exports.storage=e;
},{}],"TTyb":[function(require,module,exports) {
"use strict";var e=t(require("lodash/throttle")),a=require("./storage.js");function t(e){return e&&e.__esModule?e:{default:e}}const{saveUserData:s,getUserData:r}=a.storage,l=document.querySelector(".feedback-form"),u="feedback-form-state";i();const n={email:l.email.value,message:l.message.value};function o(e){n[e.target.name]=e.target.value,s(u,n)}function m(e){e.preventDefault();const a={email:e.currentTarget.email.value,message:e.currentTarget.message.value};console.log(a),localStorage.removeItem(u),l.reset()}function i(){const e=r(u);e&&(e.email&&(l.email.value=e.email),e.message&&(l.message.value=e.message))}l.addEventListener("submit",m),l.addEventListener("input",(0,e.default)(o,500));
},{"lodash/throttle":"Ywd4","./storage.js":"qhja"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.df6131c3.js.map