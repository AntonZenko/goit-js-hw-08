...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("iframe"),o=new Vimeo.Player(r);function a(e){localStorage.setItem("videoplayer-current-time",e.seconds)}o.on("timeupdate",(0,e.default)(a,1e3)),localStorage.getItem("videoplayer-current-time")&&o.setCurrentTime(localStorage.getItem("videoplayer-current-time"));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.d175ee89.js.map