...
},{"./debounce":"CXfR","./isObject":"u9vI"}],"qhja":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e={saveUserData:t,getUserData:r,removeUserData:o};function t(e,t){try{const o=JSON.stringify(t);localStorage.setItem(e,o)}catch(r){console.error("Set state error: ",r.message)}}function r(e){const t=localStorage.getItem(e);if(t)try{return JSON.parse(t)}catch(r){console.error("Get state error: ",r.message)}}function o(e){try{localStorage.removeItem(e)}catch(t){console.error("Remove state error: ",t.message)}}exports.default=e;
},{}],"TTyb":[function(require,module,exports) {
"use strict";var e=a(require("lodash/throttle")),t=a(require("./storage.js"));function a(e){return e&&e.__esModule?e:{default:e}}const{saveUserData:r,getUserData:s,removeUserData:n}=t.default,u=document.querySelector(".feedback-form"),o="feedback-form-state",l=s(o)||{};function i(e){l[e.target.name]=e.target.value,r(o,l)}function c(e){e.preventDefault(),console.log(l),e.target.reset(),n(o)}function d(){const e=s(o);e&&e&&(u.email.value=e.email,u.message.value=e.message)}u.addEventListener("submit",c),u.addEventListener("input",(0,e.default)(i,500)),d();
},{"lodash/throttle":"Ywd4","./storage.js":"qhja"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.b781bb71.js.map